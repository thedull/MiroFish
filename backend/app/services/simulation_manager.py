...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Steps:
        1. Read and filter entities from the Zep knowledge graph
        2. Generate OASIS Agent Profiles for each entity (optional LLM enhancement, supports parallel execution)
        ...
        try:
            ...
            # Reddit profiles are already saved in real-time during generation; save again here to ensure completeness
            if progress_callback:
                progress_callback(
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                ...
                f"2. Run the simulation (scripts located at {scripts_dir}):\n"
