...
# Flag indicating whether the cleanup function has already been registered
...
class SimulationRunState:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            # Per-platform independent rounds and simulated time
...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        max_rounds: int = None,  # Maximum simulation rounds (optional, used to cap overly long simulations)
        ...
        # If max_rounds is specified, cap the total rounds
        ...
        try:
            ...
            # Create the main log file to avoid blocking the process due to a full stdout/stderr pipe buffer
            ...
            # Set the working directory to the simulation directory (databases etc. are created there).
            ...
            process = subprocess.Popen(
                ...
                start_new_session=True,  # Create a new process group so all related processes are terminated when the server shuts down
            )
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                # Update round information (from round_end events)
                                    ...
                                    # Update per-platform independent rounds and simulated time
                                    if platform == "twitter":
    ...
    def _check_all_platforms_completed(cls, state: SimulationRunState) -> bool:
        ...
        Platform enablement is determined by checking whether the corresponding
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                try:
                    ...
                    # Get platform: prefer the platform field in the record; fall back to default_platform
    ...
    def get_all_actions(
        ...
        # If per-platform files do not exist, fall back to the old single-file format
        if not actions:
            ...
            try:
                if process.poll() is None:  # Process is still running
                    ...
                    try:
                        ...
                        # Process may no longer exist; try terminating directly
                        try:
                            process.terminate()
    ...
    def register_cleanup(cls):
        ...
        # If not in debug mode, this environment variable is absent, but we still register.
        ...
        try:
            ...
            # Not in the main thread; atexit is the only option
    ...
    def close_simulation_env(
        ...
        """
        Close the simulation environment (as opposed to stopping the simulation process)
        ...
        try:
            ...
            # A timeout may mean the environment is in the process of closing
            return {
                "success": True,
    ...
    def get_interview_history(
        ...
        Args:
            ...
            agent_id: Specify an agent ID (optional; returns only that agent's history)
