...
Reads nodes from the Zep knowledge graph and filters for nodes that match predefined entity types
"""
...
class ZepEntityReader:
    ...
    2. Filter for nodes that match predefined entity types
       (nodes whose Labels contain more than just "Entity")
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        """
        Retrieve all edges related to a given node (with retry logic)
    ...
    def filter_defined_entities(
        ...
        - If a node's Labels contain a label other than "Entity" and "Node", it matches a predefined type and is kept
        ...
        # Filter nodes that meet the criteria
        filtered_entities = []
        ...
        for node in all_nodes:
            ...
            if not custom_labels:
                # Only default labels present — skip this node
                continue
    ...
    def get_entity_with_context(
        ...
        """
        Retrieve a single entity along with its full context (edges and related nodes, with retry logic)
        ...
        """
        try:
            # Retrieve the node with retry logic
