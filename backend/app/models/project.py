...
Used to persist project state on the server side, avoiding large data transfers
between the frontend and API endpoints
"""
...
class ProjectStatus(str, Enum):
    ...
    GRAPH_BUILDING = "graph_building"    # knowledge graph is being built
    GRAPH_COMPLETED = "graph_completed"  # knowledge graph build completed
